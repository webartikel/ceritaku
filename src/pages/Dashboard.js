  ...
  return `
    <aside class="admin-sidebar" id="admin-sidebar">
      <nav class="sidebar-nav">
        ...
        <a href="#/admin/categories" class="sidebar-link ${activePage === 'categories' ? 'active' : ''}" data-route="/admin/categories">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 20h16a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2z"/><path d="M4 6h16"/><path d="M4 10h16"/><path d="M8 14h8"/><path d="M8 18h8"/></svg>
          Kelola Kategori
        </a>
